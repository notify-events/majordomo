...
$dictionary = [
    ...
    'NE_LEVEL_ENABLED_HELP' => '<p style="margin-bottom: 5px">Notify.Events позволяет вам использовать <b>приоритет</b> сообщения, в качестве фильтра для определения получателей этого сообщения.'
        . '<br>Для того, чтобы воспользоваться этим функционалом, вам необходимо сначала установить соответствие <b>уровня</b> сообщения в MajorDoMo его <b>приоритету</b> в Notify.Events, воспользовавшись формой ниже.</p>'
        . '<ul style="margin-bottom: 5px; padding-left: 25px;">'
            . '<li>Крайнее левое значение <b>уровня</b> (0) - наивысший <b>приоритет</b>.</li>'
            . '<li>Крайнее правое значение <b>уровня</b> (эквивалентно значению переменной minMsgLevel) - самый низкий <b>приоритет</b>.</li>'
        . '</ul>'
        . '<p>Установите диапазоны уровней согласно вашему видению, чтобы они соответствовали необходимым вам приоритетам.'
        . '<br>Например: Критичный приоритет будет от 0 до 2 (0 <= N < 2), высокий - от 2 до 4 (2 <= N < 4) и т.д.</p>',
    'NE_LEVEL'              => 'Уровень',
